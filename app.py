...
fig = plt.figure(figsize=(12,6))
plt.plot(ma10,'r',label = 'MovingAverage10')
plt.plot(dataset_train.adjusted_close,'b', label = 'Adjusted Close')
plt.xlabel('Time')
plt.ylabel('Price')
plt.legend()
st.pyplot(fig)
...
fig = plt.figure(figsize=(12,6))
plt.plot(ma10,'r',label = 'MovingAverage10')
plt.plot(ma20,'k',label = 'MovingAverage20')
plt.xlabel('Time')
plt.ylabel('Price')
plt.plot(dataset_train.adjusted_close,'b',label='Adjusted Close')
plt.legend()
...
st.write('present day(predicted price):',predicted_stock_price[int(22)][0])
st.write('previous day(Real price):',real_stock_price[int(22-1)][0])